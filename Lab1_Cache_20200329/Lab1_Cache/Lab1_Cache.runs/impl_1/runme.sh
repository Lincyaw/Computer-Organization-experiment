...
HD_PWD='C:/Users/fay/Downloads/Lab1_Cache_20200329/Lab1_Cache/Lab1_Cache.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source driver.tcl -notrace
