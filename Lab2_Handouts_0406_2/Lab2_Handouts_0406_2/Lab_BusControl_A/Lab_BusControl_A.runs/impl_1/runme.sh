...
HD_PWD='C:/Users/fay/Downloads/Lab2_Handouts_0406_2/Lab2_Handouts_0406_2/Lab_BusControl_A/Lab_BusControl_A.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_link.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_link.tcl -notrace
